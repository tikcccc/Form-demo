...
export const instances = [
  ...
  {
    id: 'inst-rfi-002',
    transmittalNo: 'RFI-2024-0002',
    templateId: 'rfi-default',
    title: 'Overdue ceiling coordination',
    status: 'Sent',
    createdBy: 'contractor',
    createdAt: '2023-12-01',
    formData: {
      title: 'Overdue ceiling coordination',
      subject: 'Ceiling MEP clash',
      discipline: 'MEP',
      priority: 'Medium',
      impact: 'No',
      costImpact: 0,
      scheduleImpact: 0,
      question: 'Please confirm the coordination point for the ceiling grid near the MEP riser.',
    },
    attachments: [],
    steps: [
      {
        ...
        toGroups: ['MTR', 'SConE', 'CM'],
        sentAt: '2023-12-01',
        sentAtTime: '2023-12-01T09:00:00Z',
        openedAt: '',
        dueDate: '2023-12-05',
        lastStep: true,
        requiresAttachmentStatus: false,
        message: 'Need response ASAP.',
      },
    ],
  },
  {
